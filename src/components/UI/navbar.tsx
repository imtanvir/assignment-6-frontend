              ...
              <NavbarItem key={item.href}>
                <NextLink
                  className={clsx(
                    ...
                    `${isActive ? "text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700" : ""} data-[active=true]:text-primary data-[active=true]:font-medium`
                  )}
                  color="foreground"
                  href={item.href}
                >
